...
public class BankApplication {
    ...
    public SavingAccount getDemoSavingAccount1(@Value("${client1.savingAccountInitialValue:0}")
                                                   double initialBalance ) {
        return new SavingAccount(initialBalance);
    }

    @Bean(name = "checkingAccount1")
    public CheckingAccount getDemoCheckingAccount1(@Value("${client1.checkingAccountInitialValue:0}")
                                                   double overdraft) {
    ...
    public CheckingAccount getDemoCheckingAccount2(@Value("${client2.checkingAccountInitialValue:0}")
                                                    double overdraft) {
        return new CheckingAccount(overdraft);
    }
